...
const config = convict({
	...
	roles: {
		...
		moderator: {
			doc: 'Discord Role ID that will be given to moderators',
			format: String,
			default: null,
			env: 'FPAUTH_MODERATOR_ROLE'
		}
	},
	updateNickname: {
	...
	authWindow: {
		doc: 'The amount seconds that a user has to link his account otherwise he is kicked',
		format: 'nat',
		default: 600,
		env: 'FPAUTH_AUTH_WINDOW'
	},
	cleanupInterval: {
