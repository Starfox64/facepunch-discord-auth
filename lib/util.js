...
util.sendWelcomeMessage = async function sendWelcomeMessage(channel, user, token) {
	...
	await channel.send(`Hello <@${user.id}>! You need to link your Facepunch account to use this server. To do so you need to edit your Facepunch profile (https://facepunch.com/profile.php?do=editprofile) and set your **Flickr username** to **${escapeMarkdown(token)}**
